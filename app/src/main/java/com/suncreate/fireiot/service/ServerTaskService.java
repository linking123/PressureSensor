...
public class ServerTaskService extends IntentService {
    ...
    public static final String ACTION_PUB_BLOG_COMMENT = "com.suncreate.fireiot.ACTION_PUB_BLOG_COMMENT";
    public static final String ACTION_PUB_COMMENT = "com.suncreate.fireiot.ACTION_PUB_COMMENT";
    public static final String ACTION_PUB_POST = "com.suncreate.fireiot.ACTION_PUB_POST";
    public static final String ACTION_PUB_TWEET = "com.suncreate.fireiot.ACTION_PUB_TWEET";
    public static final String ACTION_PUB_SOFTWARE_TWEET = "com.suncreate.fireiot" +
