...
public abstract class BaseListAdapter<T> extends BaseAdapter implements ViewHolder.Callback {
    ...
    protected ItemOnCheckListener mItemOnCheckListener;

    public void setmItemOnCheckListener(ItemOnCheckListener mItemOnCheckListener) {
        this.mItemOnCheckListener = mItemOnCheckListener;
    }

    public interface ItemOnCheckListener{
        void noticeCheck(boolean isChecked);
    }
}
