...
import com.suncreate.fireiot.bean.carBrand.AddressAdapter;
...
//
//        //点击item中的编辑按钮
//        com.suncreate.fireiot.util.ViewHolder.get(convertView, R.id.tv_arrow_right2).setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        com.suncreate.fireiot.util.ViewHolder.get(, R.id.tv_arrow_right2).setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Address address = ((Address) mAdapter.getItem(position));
//                if (address != null) {
