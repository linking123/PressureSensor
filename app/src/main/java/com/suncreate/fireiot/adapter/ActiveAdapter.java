...
import com.suncreate.fireiot.bean.Active;
import com.suncreate.fireiot.bean.Active.ObjectReply;
import com.suncreate.fireiot.emoji.InputHelper;
import com.suncreate.fireiot.ui.OSCPhotosActivity;
import com.suncreate.fireiot.util.BitmapHelper;
import com.suncreate.fireiot.util.ImageUtils;
import com.suncreate.fireiot.util.PlatfromUtil;
...
import com.suncreate.fireiot.widget.MyLinkMovementMethod;
import com.suncreate.fireiot.widget.MyURLSpan;
import com.suncreate.fireiot.widget.TweetTextView;
...
public class ActiveAdapter extends ListBaseAdapter {
    ...
    private final static String MAIN_HOST = "http://www.fireiot.com";
