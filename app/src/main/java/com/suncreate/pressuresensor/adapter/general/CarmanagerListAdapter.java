...
public class CarmanagerListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //车标
        ImageView carbrand = com.suncreate.pressuresensor.util.ViewHolder.get(convertView, R.id.car_brand);
        ...
        //车品牌名称
        TextView carbrand_name = com.suncreate.pressuresensor.util.ViewHolder.get(convertView, R.id.tv_car_brand_name);
        String carbrandName = "";
        ...
        //车牌号
        TextView carbrand_num = com.suncreate.pressuresensor.util.ViewHolder.get(convertView, R.id.tv_car_num);
        ...
        //车品牌+车型+排量+年份
        TextView tv_car_brand_detail = com.suncreate.pressuresensor.util.ViewHolder.get(convertView, R.id.tv_car_brand_detail);
        if (!StringUtils.isEmpty(carbrandDetail)) {
            tv_car_brand_detail.setText(carbrandDetail);
        }

        //默认爱车
        final CheckBox cb_select_as_lovecar = com.suncreate.pressuresensor.util.ViewHolder.get(convertView, R.id.cb_select_as_lovecar);
...
//                                    user.setUserBrandid(Long.parseLong(carmodelId));
        ...
        //点击item中的编辑按钮
        com.suncreate.pressuresensor.util.ViewHolder.get(convertView, R.id.btn_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle b = new Bundle();
        ...
        com.suncreate.pressuresensor.util.ViewHolder.get(convertView, R.id.btn_del).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
