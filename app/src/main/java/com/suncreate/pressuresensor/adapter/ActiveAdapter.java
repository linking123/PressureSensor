...
import com.suncreate.pressuresensor.bean.Active;
import com.suncreate.pressuresensor.bean.Active.ObjectReply;
import com.suncreate.pressuresensor.emoji.InputHelper;
import com.suncreate.pressuresensor.ui.OSCPhotosActivity;
import com.suncreate.pressuresensor.util.BitmapHelper;
import com.suncreate.pressuresensor.util.ImageUtils;
import com.suncreate.pressuresensor.util.PlatfromUtil;
...
public class ActiveAdapter extends ListBaseAdapter {
    ...
    private final static String MAIN_HOST = "http://www.pressuresensor.com";
