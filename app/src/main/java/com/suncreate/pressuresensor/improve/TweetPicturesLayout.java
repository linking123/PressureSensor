package com.suncreate.pressuresensor.improve;
...
//    }
    ...
    public void onClick(View v) {
        ...
        com.suncreate.pressuresensor.meidia.ImageGalleryActivity.show(getContext(), Tweet.Image.getImagePath(images), index);
    }
}
