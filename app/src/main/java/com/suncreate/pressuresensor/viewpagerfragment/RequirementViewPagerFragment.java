...
import com.suncreate.pressuresensor.fragment.requirement.ServiceRequirementFragment;
import com.suncreate.pressuresensor.interf.OnTabReselectListener;

/**
 * 需求Tab界面
 */
public class RequirementViewPagerFragment extends BaseViewPagerFragment implements
    ...
    protected void onSetupTabAdapter(ViewPageFragmentAdapter adapter) {
        String[] title = getResources().getStringArray(
                R.array.requirement_viewpager_arrays);

        adapter.addTab(title[0], "service_require", ServiceRequirementFragment.class,
                getBundle(1));
        adapter.addTab(title[1], "accessory_require", AccessoryRequirementFragment.class,
                getBundle(2));
    }
