...
public class ImageAdapter extends BaseRecyclerAdapter<Image> {
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        if (type == 0)
            return new CamViewHolder(mInflater.inflate(R.layout.fragment_item_list_cam, parent, false));
        return new ImageViewHolder(mInflater.inflate(R.layout.fragment_item_list_image, parent, false));
    }
