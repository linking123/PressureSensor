 ...
 * 慢肌训练
 */
public class SlowMuscleTrainingActivity extends BaseActivityBlueToothLE implements BaseViewInterface, View.OnClickListener {

    public static final String TAG = "SlowMuscleTrainingAct";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ps_slowmuscle_training);
