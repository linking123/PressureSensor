...
import com.suncreate.pressuresensor.widget.ps.DialChart03View;
 ...
 * 便秘训练
 */
public class ConstipineTrainingActivity extends BaseActivityBlueToothLE implements BaseViewInterface, View.OnClickListener {

    public static final String TAG = "ConstipineTrainingAct";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ps_constipine_training);
