...
import com.suncreate.pressuresensor.bean.NoticeDetail;
import com.suncreate.pressuresensor.bean.Result;
import com.suncreate.pressuresensor.bean.ResultBean;
import com.suncreate.pressuresensor.broadcast.AlarmReceiver;
...
import com.suncreate.pressuresensor.service.INoticeService;

public class NoticeService extends Service {
    public static final String TAG = "NoticeService";

    public static final String INTENT_ACTION_GET = "com.suncreate.pressuresensor.service.GET_NOTICE";
    public static final String INTENT_ACTION_CLEAR = "com.suncreate.pressuresensor.service.CLEAR_NOTICE";
    public static final String INTENT_ACTION_BROADCAST = "com.suncreate.pressuresensor.service.BROADCAST";
    public static final String INTENT_ACTION_SHUTDOWN = "com.suncreate.pressuresensor.service.SHUTDOWN";
    public static final String INTENT_ACTION_REQUEST = "com.suncreate.pressuresensor.service.REQUEST";
    public static final String BUNDLE_KEY_TPYE = "bundle_key_type";

    private static final long INTERVAL = 1000 * 300;//定时任务时间间隔
...
//        WukongApi.clearNotice(uid, type, mClearNoticeHandler);
    }
...
//        WukongApi.getNotices(mGetNoticeHandler);
    }
