 ...
 */
public class RegisterRegetPwdFragment extends BaseFragment {
    protected static final String TAG = RegisterRegetPwdFragment.class.getSimpleName();
...
//    private String mUsername;
    ...
    private boolean prepareForRegister() {
        ...
        if (!TypeChk.isPhoneNum(mPhoneNum.getText().toString())) {
            mPhoneNum.setError(getString(R.string.tip_illegal_phone));
    ...
    private void handleRegister() {
        ...
        if (verifyType == REPAIR_PWD) {
            PressureSensorApi.password(mPassword, mRepairHandler);
        } else if (verifyType == REGET_PWD) {
            PressureSensorApi.resetPassword(mPhoneNum.getText().toString(), mPassword, mRegetPwdHandler);
        } else {
            hideWaitDialog();
