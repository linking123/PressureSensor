...
import com.suncreate.pressuresensor.widget.ViewHomeHeader;
...
import static com.suncreate.pressuresensor.R.id.rl_master_report;
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case rl_master_report:
                UIHelper.openBrowser(getContext(), "https://manage.pressuresensor.com/web/mobile/Enroll/jx");
                break;
            default:
                break;
        }
