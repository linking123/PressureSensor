...
import com.suncreate.pressuresensor.adapter.base.StoreListAdapter;
...
import com.suncreate.pressuresensor.bean.user.FillGoodsOrder;
import com.suncreate.pressuresensor.bean.user.GoodsOrder;
import com.suncreate.pressuresensor.bean.user.GoodsOrderForTrans;
import com.suncreate.pressuresensor.bean.user.Pay;
import com.suncreate.pressuresensor.bean.user.PriceByAddress;
import com.suncreate.pressuresensor.bean.user.ShoppingCar;
import com.suncreate.pressuresensor.bean.user.ShoppingStore;
import com.suncreate.pressuresensor.bean.user.StorePriceByAddress;
import com.suncreate.pressuresensor.bean.user.SubmitGoodsOrder;
