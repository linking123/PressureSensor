 ...
 * ListView右侧的字母索引View
 */
public class SideBarForCarBrand extends View {
    ...
    public SideBarForCarBrand(Context context) {
        this(context, null);
    }

    public SideBarForCarBrand(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SideBarForCarBrand(Context context, AttributeSet attrs, int defStyle) {
