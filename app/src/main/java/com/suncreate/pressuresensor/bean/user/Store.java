...
public class Store implements Serializable {
    ...
    public String getStoreCardOpposite() {
        return storeCardOpposite;
    }

    public void setStoreCardOpposite(String storeCardOpposite) {
        this.storeCardOpposite = storeCardOpposite;
    }
    ...
    public void setStoreTecType(String storeTecType) {
        this.storeTecType = storeTecType;
    }
    ...
    public void setTecphoto1Id(String tecphoto1Id) {
        this.tecphoto1Id = tecphoto1Id;
    }
