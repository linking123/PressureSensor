package com.suncreate.pressuresensor.bean.citypicker;
 ...
 * ListView右侧的字母索引View
 */
public class SideBarForCityPicker extends View {
    ...
    public SideBarForCityPicker(Context context) {
        this(context, null);
    }

    public SideBarForCityPicker(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SideBarForCityPicker(Context context, AttributeSet attrs, int defStyle) {
