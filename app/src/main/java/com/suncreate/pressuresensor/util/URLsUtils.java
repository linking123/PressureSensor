            ...
            if (url.getHost().contains(URL_HOST)) {
                ...
                if (path.contains(URL_TEAM_HOST)) {
                    ...
                    // 问答
                        ...
                        // 问答-标签 http://www.fireiot.com/question/tag/python
                        ...
                        // 问答 www.pressuresensor.com/question/12_45738
                        else {
